...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--context_frames', type=int, default=1000, help= '# of frames before predictions.')
        ...
        self.parser.add_argument('--epochs', type=int, default=50, help='# total training epoch')
        self.opt = None
